...
namespace LangHelper
{
    ...
    public class LanguageHelper
    {
        ...
        #region Constructor
        public LanguageHelper(eLanguageType language)
        {
		...
		private void init_Economy()
		{
			Language.Add("ORDERID", "订单编号");
			Language.Add("QUANTITY", "股票数量"); 
			Language.Add("SYMBOL", "股票代码");
			Language.Add("STOCKPRICE", "股票价格");
			Language.Add("FEERATE", "费率");
			Language.Add("FUNDACCOUNTID", "资金账号");
			Language.Add("MARKET", "市场");
			Language.Add("REQMONEYTYPE", "请求币种");
			Language.Add("REQAMT", "请求金额");
			Language.Add("PAYAMT", "支付金额");
			Language.Add("DESTMONEYTYPE", "到账币种");
			Language.Add("DESTAMT", "到账金额");
			Language.Add("PAYSTATUS", "支付结果");
			Language.Add("PAYDATE", "支付日期");
			Language.Add("MEMO", "备注");

			if (!Language.ContainsKey("LASTMODIFYTIME"))
			{
				Language.Add("LASTMODIFYTIME", "最后保存时间");
			}
			//Language.Add("", "");
		...
		{
			Language.Add("STARTDATE", "开始日期");
			Language.Add("ENDDATE", "结束日期");
		}
