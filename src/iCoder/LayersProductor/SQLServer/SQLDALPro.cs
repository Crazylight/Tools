...
{
	internal class SQLDALPro : CommonPro
	{
		static SQLDALPro instance;
		public SQLDALPro(DataTable dt, string projName, string entityName)
			: base(dt, projName, entityName)
		{

		}
		public static SQLDALPro getInstance(DataTable dt, string projName, string classname, string entityName)
		{
			// if (instance == null)
			{
				instance = new SQLDALPro(dt, projName, entityName);
			}
			return instance;
		}
		...
		public string CreateDAL()
		{
			...
			#region Temp
			//sb.Append("#region Temp\r\n");
			//sb.Append("          /// <summary>\r\n");
			//sb.Append("          /// 更新记录到正式表\r\n");
			//sb.Append("          /// </summary>\r\n");
			//sb.Append("      public void UpdateTempInfoToMainInfo (string ids)\r\n");
			//sb.Append("      {\r\n");
			...
			//    update.Append(" B." + _dt.Rows[i]["name"].ToString().ToUpper() + ", ");
			//}
			//update.Remove(update.Length - 2, 2);
			//update.Append(" FROM (SELECT ");
			//for (int i = 0; i < _dt.Rows.Count; i++)
			//{
			//    if (_dt.Rows[i]["name"].ToString().ToLower().Equals("id"))
			//        continue;
			//    update.Append(_dt.Rows[i]["name"].ToString().ToUpper() + ", ");
			//}
			//update.Append(" FROM " + _dt.TableName + "TEMP ) B WHERE " + _dt.TableName + ".ID = B.ID AND B.ID IN(\" + ids + \")");
		...
		private string CreateMethods()
		{
			...
			sb.Append("             try\r\n");
			sb.Append("             {\r\n");
			sb.Append("                res.Data =  _sqlH.GetDataTable(sql);\r\n");
			sb.Append("             }\r\n");
			sb.Append("             catch(Exception e)\r\n");
			sb.Append("             {\r\n");
			sb.Append("                 _LogWrite(e);\r\n");
			...
			sb.Append("          /// 根据条件获取DataTable\r\n");
			sb.Append("          /// </summary>\r\n");
			sb.Append("         public Result Get" + _entityName + "DtByConditions(string conditions");
			...
			sb.Append("             try\r\n");
			sb.Append("             {\r\n");
			sb.Append("                res.Data =  _sqlH.GetDataTable(sql, start_index, count);\r\n");
			sb.Append("             }\r\n");
			sb.Append("             catch(Exception e)\r\n");
			sb.Append("             {\r\n");
			sb.Append("                 _LogWrite(e);\r\n");
			...
			sb.Append("          /// 根据条件获取DataTable\r\n");
			sb.Append("          /// </summary>\r\n");
			sb.Append("         public Result GetExport" + _entityName + "DtByConditions(string conditions)\r\n");
			sb.Append("         {\r\n");
			sb.Append("                 Result res = new Result();\r\n");
			sb.Append("                 string sql = \"SELECT ");
			foreach (DataRow dr in _dt.Rows)
			...
			sb.Append("             try\r\n");
			sb.Append("             {\r\n");
			sb.Append("                count = _sqlH.GetScalar<int>(sql);\r\n");
			sb.Append("             }\r\n");
			sb.Append("             catch(Exception e)\r\n");
			sb.Append("             {\r\n");
			sb.Append("                 _LogWrite(e);\r\n");
		...
		private string Insert()
		{
			...
			insert.Append("          try\r\n");
			insert.Append("           {\r\n");
			insert.Append("             res.Data = _sqlH.GetScalar<int>(sql);\r\n");
			insert.Append("           }\r\n");
